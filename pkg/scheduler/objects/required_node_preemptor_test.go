...
func TestGetVictims(t *testing.T) {
	...
	assert.Equal(t, victims[1].GetAllocationKey(), "ask4")
	assert.Equal(t, resources.Equals(victims[1].GetAllocatedResource(), resources.NewResourceFromMap(map[string]resources.Quantity{"first": 5})), true)
	assert.Equal(t, victims[2].GetAllocationKey(), "ask2")
	assert.Equal(t, resources.Equals(victims[2].GetAllocatedResource(), resources.NewResourceFromMap(map[string]resources.Quantity{"first": 8})), true)
	assert.Equal(t, victims[3].GetAllocationKey(), "ask1")
	assert.Equal(t, resources.Equals(victims[3].GetAllocatedResource(), resources.NewResourceFromMap(map[string]resources.Quantity{"first": 10})), true)
	removeAllocationAsks(node, asks)
